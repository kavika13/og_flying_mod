...
void FlyingAnimations() {
	if (!jump_info.hit_wall) {
		...
		//Gliding
			...
			if(this_mo.velocity.y < -24.0f) this_mo.SetAnimation("Data/Animations/flying_mod/diving.anm", 5.0f, 0);
			else this_mo.SetAnimation("Data/Animations/flying_mod/glide.anm", 5.0f, 0);
			}
